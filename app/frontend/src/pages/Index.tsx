...
const classes = [
  {
    ...
    mascotImage: 'https://mgx-backend-cdn.metadl.com/generate/images/1277232/2026-05-25/piwwhpqaagxa/mascot-otter-blue.png',
  ...
  },
  {
    ...
    mascotImage: 'https://mgx-backend-cdn.metadl.com/generate/images/1277232/2026-05-25/piwwd5iaagvq/mascot-lion-orange.png',
  ...
  },
  {
    ...
    mascotImage: 'https://mgx-backend-cdn.metadl.com/generate/images/1277232/2026-05-25/piwwdsqaagwa/mascot-fox-redpurple.png',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {classes.map((cls) => (
            <Link key={cls.id} to={`/class/${cls.id}`} className="block group">
              <Card
                className={`overflow-hidden border ${cls.borderColor} ${cls.hoverBorder} transition-all duration-300 hover:shadow-xl ${cls.bgGlow} hover:-translate-y-2 cursor-pointer bg-gray-900/80`}
              >
                {/* Banner Image */}
